...
source("/projectnb/dietzelab/malmborg/EDF_C_Portfolio_Project/10_EDF_Change_Over_Time_California_analyses_script.R")
...
cp$region <- "CA"
# save it:
write.csv(cp, file = paste0(save_dir, Sys.Date(), "_COT_CA_crop_portfolio_", names(crop_group_list)[task_id], ".csv"))
...
saveRDS(SD_vs_area, paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_CA_portfolio_", portfolio_name,"_SD_vs_pixels_plot.rds"))
ggsave(paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_CA_portfolio_", portfolio_name,"_SD_vs_pixels_plot.png"),
       plot = SD_vs_area,
       width = 10, height = 6,
       dpi = 600)

saveRDS(SD_vs_area, paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_CA_portfolio_", portfolio_name,"_delta_vs_pixels_plot.rds"))
ggsave(paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_CA_portfolio_", portfolio_name,"_delta_vs_pixels_plot.png"),
       plot = delta_vs_area,
       width = 10, height = 6,
       dpi = 600)

saveRDS(SD_vs_area, paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_CA_portfolio_", portfolio_name,"_ratio_vs_pixels_plot.rds"))
ggsave(paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_CA_portfolio_", portfolio_name,"_ratio_vs_pixels_plot.png"),
       plot = ratio_vs_area,
       width = 10, height = 6,
       dpi = 600)

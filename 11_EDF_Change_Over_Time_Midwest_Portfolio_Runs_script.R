...
saveRDS(SD_vs_area, paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_MW_portfolio_", portfolio_name,"_SD_vs_pixels_plot.rds"))
ggsave(paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_MW_portfolio_", portfolio_name,"_SD_vs_pixels_plot.png"),
       plot = SD_vs_area,
       width = 10, height = 6,
       dpi = 600)

saveRDS(SD_vs_area, paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_MW_portfolio_", portfolio_name,"_delta_vs_pixels_plot.rds"))
ggsave(paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_MW_portfolio_", portfolio_name,"_delta_vs_pixels_plot.png"),
       plot = delta_vs_area,
       width = 10, height = 6,
       dpi = 600)

saveRDS(SD_vs_area, paste0(save_dir, "Change_Over_Time_Plots/", Sys.Date(), "_COT_MW_portfolio_", portfolio_name,"_ratio_vs_pixels_plot.rds"))
